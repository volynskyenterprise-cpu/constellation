...
Thesis generation is a separate v2.5 step. It creates proposed institutional theses from cross-document findings and does not mutate PKOS packages or external vaults.
